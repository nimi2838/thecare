...
<head>
  ...
  <link rel="stylesheet" href="css/noti-5.css" />
  <title>공지사항</title>
</head>
<%
    ...
    <section id="noti" class="content">
        <div class="inner">
            ...
            <div class="wrap">
                <div class="tit">
                    <h4>[공지]</h4>
                    <span>미성년자 시술 및 관리 동의서</span>
                    <p>2022.03.30</p>
                </div>
                <div class="txt">
                    <img src="img/noti-5.jpg" alt="">

                    <p>미성년자 고객님께서는 하단의 서류를 인쇄하여<br>
                        법정대리인(부모님만 가능)의 서명을 받은 후 지참하여 내원하시기 바랍니다.<br>
                         <br>
                        더 궁금한 사항은 02-517-0912로 연락 주시기 바랍니다.<br>
                        <br>
                        감사합니다 !</p>
                </div>
                <div class="wow">
