...
<%
    ...
    String opPrice = request.getParameter("opPrice");
...
try {
	 ...
	 String jsql = "INSERT INTO surgery(ctgType, prdNo, prdName, startprice) VALUES (?,?,?,?)";
	 PreparedStatement pstmt = con.prepareStatement(jsql);
	 pstmt.setString(1, ctgType);
	 pstmt.setString(2, prdNo);
	 pstmt.setString(3, prdName);  
	 pstmt.setString(4, startprice);
...
%>
	...
	String jsql1 = "INSERT INTO soption(prdNo, opNo, opName, opPrice) VALUES (?,?,?,?)";
	 PreparedStatement pstmt1 = con.prepareStatement(jsql1);
	 pstmt1.setString(1, prdNo);
	 pstmt1.setString(2, opNo);
	 pstmt1.setString(3, opName);  
	 pstmt1.setString(4, opPrice);
    ...
    <div class = "join_main">
        <div class = "inner">
            <div class = "join_box">
                <h1 style = "font-size : 22px; line-height: 31px;">시술 등록완료 <br>시술이 등록되었습니다!</h1>
                    <table class="table">
        
      
		               <tr>
                        <td>카테고리</td>
						<td class = "td_tit"><%=ctgType%></td>
                       </tr>

					    <tr>
                        <td>시술번호</td>
						<td class = "td_tit"><%=prdNo%></td>
                       </tr>

					    <tr>
                        <td>시술이름</td>
						<td class = "td_tit"><%=prdName%></td>
                       </tr>

					    <tr>
                        <td>시술가격</td>
						<td class = "td_tit"><%=startprice%></td>
                       </tr>

					   <tr>
                        <td>옵션번호</td>
						<td class = "td_tit"><%=opNo%></td>
                       </tr>

					   <tr>
                        <td>옵션이름</td>
						<td class = "td_tit"><%=opName%></td>
                       </tr>

					   <tr>
                        <td>옵션가격</td>
						<td class = "td_tit"><%=opPrice%>원</td>
                       </tr>
						</table>
                   
                     <a href="manager_main.jsp" class="join_btn">메인화면</a>
                    </div>
                    </form>
                 </div>
              </div>
