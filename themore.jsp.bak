            ...
            <div class="inner">
                <div class="wrap">
                    ...
                    <div class="con">
                        ...
                        <div class="you">
                            <div class="box box1">
                                <p class="p-left">피지 분비량과 수분 보유랑<br>
                                    모두 적어 거칠고<br>
                                    각질과 주름이 잘 생기는 타입
                                </p>
                    ...
                    <div class="con">
                        ...
                        <div class="you">
                            <div class="box box3">
                                <p class="p-left" style="margin-top: 30px;">피부가 얇고 섬세해<Br>
                                    외부 자극에 쉽게 반응하는 타입
                                </p>
                    ...
                    <div class="con">
                        ...
                        <div class="you">
                            ...
                            <div class="box box6">
                                <p class="p-right" style="margin-top: 30px;">멜라닌 활성도가 낮아<Br>
                                    눈에 보이는 색소가 적은 타입
                                </p>
