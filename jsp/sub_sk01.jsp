...
//				Cookie cook = new Cookie(pno,URLEncoder.encode(name,"euc-kr"));
	...
	//			response.addCookie(cook);
			...
			while(rs1.next()) {	
				...
				int opprice = rs1.getInt("opPrice");
						...
						%>
									...
									<tbody>
											<td><input name="chkbox" type="checkbox" value="<%=opno%>"  id="chk1" onClick="itemSum(this.form);example_1(this.form);">
		...
		let example1 = document.querySelector('#chk1');
					...
					let example3 = document.querySelector('#chk3');

					function example_1(frm) {
						var cnt = frm.chkbox.length;
							   for(var i=0; i < cnt; i++ ){
