...
<%
    ...
    <section id="mogong" class="content">
        <div class="inner">
            ...
            <h2><span>피부 속까지</span> 깨끗하고 촉촉한 피부 !</h2>
        </div>
    </section>
        ...
        <div class="sub_con5">
            ...
            <div class="qna_list">
				<div class="qna_item">
					...
					<div class="answer" data-aos="fade-left">
						아쿠아필은 피부에 맞춰 솔루션을 선택할 수 있어 어떤 피부타입이더라도 시술이 가능합니다.
					</div>
				</div>
			</div>
			...
			<div class="qna_list">
				<div class="qna_item">
					...
					<div class="answer" data-aos="fade-left">
						개인의 상태에 따라 다르나 보통 40분~60분 정도 예상됩니다.
					</div>
				</div>
			</div>
			...
			<div class="qna_list">
				<div class="qna_item">
					...
					<div class="answer" data-aos="fade-left">
						아쿠아필 관리에 사용되는 제품은 AHA,BHA(수용성,지용성)이므로 어떤 피부타입도 시술이 가능하며 압력조절이 가능한 저자극 필링으로 여드름 피부에도 적용한 시술입니다.
					</div>
				</div>
			</div>
