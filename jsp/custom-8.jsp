...
%>
	...
	String aa7 = request.getParameter("aa7");
...
try {
	 ...
	 pstmt1.setString(2,"num"+7);
	 pstmt1.setString(3,aa7);
    ...
    <div class="survery content">
        <div class="inner">
            <div class="makde">
                ...
                여기는 퍼센트 넣어야 함-->
				<div>
	<progress value="80" max="100" id="lb"></progress>
</div>
            </div>
             ...
             <div class="wrap">
                <h1>피부타입 자가진단</h1>
                    ...
                    <div class="survery-test">
                        <div class="qestion">
                            <h1>Q8</h1>
                            <p>과거에 기미로 피부과를 방문한 적이 있나요?</p>
                        </div>
                        <ul class="qna-wrap">
                            <li>
                                <div class="check1-1"> 
                                    <input type="checkbox" id="q1-1" name = "aa8" value= "no3" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-1"><p>없다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-2"> 
                                    <input type="checkbox" id="q1-2" name = "aa8" value= "no3" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-2"><p>한 번 있다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-3"> 
                                    <input type="checkbox" id="q1-3" name = "aa8" value= "yes3" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-3"><p>3~4번 있다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-4"> 
                                    <input type="checkbox" id="q1-4" name = "aa8" value= "yes3" id="q1-1" onclick = "clickCheck(this)"> 
...
function Check(num){
	if ($("input:checkbox[name='aa8']").is(":checked") == false) {
		alert("답변을 선택해 주세요.");
		return false;
		
	}
	var form = document.getElementById("form");
	form.action = "custom-9.jsp";
	form.submit();
                  }
