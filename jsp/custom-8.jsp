...
try {
 ...
 %>
	...
	<progress value="80" max="100" id="lb"></progress>
            ...
            <form action="custom-9.jsp" method=post>
             <div class="wrap">
                <h1>피부타입 자가진단</h1>
                    ...
                    <div class="survery-test">
                        ...
                        <ul class="qna-wrap">
                            <li>
                                <div class="check1-1"> 
                                    <input type="checkbox" id="q1-1" name = "aa8" value= "no" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-1"><p>없다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-2"> 
                                    <input type="checkbox" id="q1-2" name = "aa8" value= "no" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-2"><p>한 번 있다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-3"> 
                                    <input type="checkbox" id="q1-3" name = "aa8" value= "yes" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-3"><p>3~4번 있다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-4"> 
                                    <input type="checkbox" id="q1-4" name = "aa8" value= "yes" id="q1-1" onclick = "clickCheck(this)"> 
