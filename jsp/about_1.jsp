  ...
  <div class="boxsize moduleWrap fnloadContent poRel box_module_box_add" id="box_module_box_add_356823"
    ...
    <div class = "cleansing">
            <div class = "inner">
                ...
                <div class = "pyo_txt">
                <p style="margin: 50px 0;">더케어가 설문 조사한 결과 <br>
				일반적으로 피부노화가 진행되는 시기가 <br>
				25세 이후임에도 불구하고 
                    <span style="color: red; font-size: 23px;">20~24세</span>의 시기에 <br>
					관리의 필요성을 느꼈다는 답이 가장 많이 나왔다. 
            ...
            <div class = "inner">
               ...
               <div class="boxs">
                    ...
                    <div class = "box_5_1">
                        ...
                        <div class="bg">
                            <div class = "box_box">
                                <p>선천적인 부분은 피부의 컨디션과 시간에 따른 변화에 상당한 영향을 끼칩니다. <br>
                                    예를 들어, <br>가족 구성원들의 모공이 넓은 편이라면, 자신의 모공도 넓을 수 있습니다. <br>
									이러한 생물학적 요인은 통제할 수 없지만 <br>건강한 피부를 유지하기 위해 최대한 노력할 수 있습니다.
									<!-- 선천적인 부분은 피부의 컨디션과 시간에 따른 변화에 상당한 영향을 끼칩니다. 
                    ...
                    <div class="bg">
                        <div class = "box_box">
                            <p style="">온도가 너무 높거나 낮은 장소<br>
								혹은 공기가 탁한 곳에 오래 있으면 <br>
                                피부가 건조하고 칙칙해지며 노폐물이 쌓이기 쉽습니다. 
                        ...
                        <div class="bg">
                            <div class = "box_box">
                                <p>
                                    ...
                                    더케어는 피부 관리에서 현재뿐 아니라 다가오는 계절까지 고려하는 스킨 케어가 가장 효과적이라는 사실을 알게 되었습니다. <br>
                                    더운 날씨에는 햇빛을 피해 피부를 보호하고 가벼운 하이드레이터로 수분을 공급해야 합니다. <br>
                                    추운 날씨에는 비타민이 풍부한 음식을 섭취하고 날카로운 바람에 대비하여 보호막을 제공하는 크림을 바를지 고민할 필요가 있습니다.
								<!-- 예를 들어, 여행을 자주 하는 사람은 날씨의 급격한 변화로 인해 피부가 건조해집니다. 
                ...
                <div class="boxss">
                    <div class = "box_5_4">
                        ...
                        <div class="bg">
                            <div class = "box_box">
                                <p>
								여행은 날씨의 급격한 변화로 인해 피부가 건조해지고 <br>
                                     극심한 기후 변화로도 피부에 상당한 영향을 줍니다. <br>
                                    여행지의 기온과 환경 차이를 고려해 피부를 관리하고,<br>
									보습에 특별히 신경을 써보세요. <br> 
								<!-- 근사한 곳 어디를 가더라도 여행은 피부에 상당한 영향을 줄 수 있고,
                    ...
                    <div class="bg">
                        <div class = "box_box">
                            <p>생활 습관과 관련한 다양한 요인은 피부의 건강에 영향을 끼칩니다. <br>
                                수면 부족, 스트레스, 흡연 및 알코올 같은 물질의 과다 섭취 가장 큰 요인이며 <br>
                                이로인해 피부톤이 칙칙해지기도 하고 피부 트러블이 자주 발생할 수 있습니다. <br>
                                가능하면 신선한 재료로 집에서 요리한 음식을 드시고 <br> 물도 많이 드시는 것이 좋습니다.</p>
                        </div>
                    </div>
                </div>
                </div>
