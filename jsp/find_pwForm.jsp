...
%>
	...
	<div class = "find_main">
                    <div class = "inner">
                        <div class = "find_box">
						<form method = "post" action = "find_pw.jsp" target=_parent>
                            <h1 style = "text-align: center;font-weight:bold;color: #4D4D4D;padding-top: 50px;padding-bottom: 20px;">FIND PW</h1>
                            <input type="text" class = "form" name="id" value="" required="true"
                            style="padding:18px; font-size:16px; margin-bottom:0.5rem;" 
                            size="20" placeholder="아이디 입력">
                            <input type="text" class = "form" name="name" value="" required="true" 
                            style="padding:18px; font-size:16px; margin-bottom:0.5rem;" 
                            size="20"  placeholder="이름 입력" autocomplete="true" onkeydown="onEnterSubmit()">
            
                           
                           <a href="javascrip!t:login_check()"><button type="submit"  class="find_btn" style= "cursor: pointer;">비밀번호 찾기</button></a>
                        ...
                        <ul class = "shc" style="margin-top:20px;">
                          ...
                          <li> | </li>
                          <li><button style="background:#fff; border:0; cursor: pointer;"><a href="find_idForm.jsp">아이디 찾기</a></button></li>
                        </ul>
                       </div>
</form>
</div>
