                ...
                size="20" placeholder="PW" autocomplete="true" onkeydown="onEnterSubmit()">
                    ...
                    <div class = "login_3menu" >
                        <ul class = "shc" style="margin-top:30px;">
                          <li> <button style="background:#fff; border:0; cursor: pointer;"><a href="">회원가입</a></button></li>
                          <li> | </li>
                          <li><button style="background:#fff; border:0; cursor: pointer;"><a href="">아이디 찾기</a></button></li>
                          <li> | </li>
