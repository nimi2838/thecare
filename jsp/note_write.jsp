...
<section id="note" class="content">
    <div class="inner">
        ...
        <div class="wrap">
            <form class="list" method="post" action="note_write_process.jsp" name="input">
                <ul>
				
                    <li>
                        <h1>제목</h1>
                        <input type="text" name="in_subject">
                    </li>
                    ...
                    <li class="text" style="border: 0;">
                        <h1>내용</h1>
                        <textarea name="in_content" id="" cols="30" rows="10">내용을 자유롭게 작성해주세요 !</textarea>
                    </li>
                </ul>

				
            <div class="button"> 
                <input class="on" type="button" name="write_submit" value="등   록" OnClick="in_check()">
                <input class="off" type="reset" name="reset" value="취   소" onClick="maintogo()">
            </div>
