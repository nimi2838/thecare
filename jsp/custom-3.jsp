...
try {
 ...
 %>
	...
	<progress value="22" max="100" id="lb"></progress>
            ...
            <form action="custom-4.jsp" method=post>
             <div class="wrap">
                <h1>피부타입 자가진단</h1>
                    ...
                    <div class="survery-test">
                        ...
                        <ul class="qna-wrap">
                            <li>
                                <div class="check1-1"> 
                                    <input type="checkbox" id="q1-1" name = "aa3" value= "no" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-1"><p>눈에 보이지 않는다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-2"> 
                                    <input type="checkbox" id="q1-2" name = "aa3" value= "no" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-2"><p>샤프심의 절반 크기이다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-3"> 
                                    <input type="checkbox" id="q1-3" name = "aa3" value= "yes" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-3"><p>샤프심만한 크기이다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-4"> 
                                    <input type="checkbox" id="q1-4" name = "aa3" value= "yes" id="q1-1" onclick = "clickCheck(this)"> 
