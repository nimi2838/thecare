...
try {
	 ...
	 pstmt1.setString(2,"num"+2);
	 pstmt1.setString(3,aa2);
...
<iframe id="iframe1" name="iframe1" style="display:none"></iframe>
    ...
    <div class="survery content" target="iframe1">
        <div class="inner">
            <div class="makde">
                ...
                여기는 퍼센트 넣어야 함-->
				<div>
	<progress value="22" max="100" id="lb"></progress>
</div>
            </div>
             ...
             <div class="wrap">
                <h1>피부타입 자가진단</h1>
                    ...
                    <div class="survery-test">
                        <div class="qestion">
                            <h1>Q3</h1>
                            <p>얼굴 모공 크기는 얼마나 큰가요 ? (거울을 보고 확인해보세요.)</p>
                        </div>
                        <ul class="qna-wrap">
                            <li>
                                <div class="check1-1"> 
                                    <input type="checkbox" id="q1-1" name = "aa3" value= "no1" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-1"><p>눈에 보이지 않는다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-2"> 
                                    <input type="checkbox" id="q1-2" name = "aa3" value= "no1" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-2"><p>샤프심의 절반 크기이다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-3"> 
                                    <input type="checkbox" id="q1-3" name = "aa3" value= "yes1" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-3"><p>샤프심만한 크기이다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-4"> 
                                    <input type="checkbox" id="q1-4" name = "aa3" value= "yes1" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-4"><p>연필심만한 크기이다</p> </label> 
                                </div>
                            </li>
                        </ul>
...
function reloadDivArea() {
    $('.survery content').load(location.href+' .survery content');
}
...
function Check(num){
	if ($("input:checkbox[name='aa3']").is(":checked") == false) {
		alert("답변을 선택해주세요.");
		return false;
		
	}
	var form = document.getElementById("form");
	form.action = "custom-4.jsp";
	form.submit();
                  }
