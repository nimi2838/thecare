...
<div class = "find_main">
    ...
    <h2 style = "text-align: center; margin-top: 70px;">회원님의 아이디는 <span style="color:#fd9b9b;"><%=id%></span>입니다.</h2>
						   ...
						   <p style = "margin-top: 20px; text-align: center; color: #4d4d4d;">비밀번호를 모르시나요? <a href = "find_pwForm.jsp" style= "text-decoration: underline #4d4d4d; font-weight:bold;">비밀번호 찾기</a></p>
