...
try {
	 ...
	 pstmt1.setString(2,"no"+4);
	 pstmt1.setString(3,aa4);
 ...
 %>
	...
	<progress value="45" max="100" id="lb"></progress>
            ...
            <form action="custom-6.jsp" method=post>
            <div class="wrap">
                <h1>피부타입 자가진단</h1>
                    ...
                    <div class="survery-test">
                        <div class="qestion">
                            <h1>Q5</h1>
                            <p>최근 1년 내에 여드름이나 홍조로 인해 피부과를 방문을 한 적이 있나요?</p>
                        </div>
                        <ul class="qna-wrap">
                            <li>
                                <div class="check1-1"> 
                                    <input type="checkbox" id="q1-1" name = "aa5" value= "no" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-1"><p>없다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-2"> 
                                    <input type="checkbox" id="q1-2" name = "aa5" value= "no" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-2"><p>한 번 있다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-3"> 
                                    <input type="checkbox" id="q1-3" name = "aa5" value= "yes" id="q1-1" onclick = "clickCheck(this)"> 
                                    <label for="q1-3"><p>3-4번 있다</p> </label> 
                                </div>
                            </li>
                            <li>
                                <div class="check1-4"> 
                                    <input type="checkbox" id="q1-4" name = "aa5" value= "yes" id="q1-1" onclick = "clickCheck(this)"> 
