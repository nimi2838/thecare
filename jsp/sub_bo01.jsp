			...
			while(rs1.next()) {	
				...
				priceArray[j] = opprice;
						...
						%>
									...
									<tbody>
											<td><input name="chkbox" type="checkbox" value="<%=opprice%>" class="opprice" id="noArray[j]" onClick="itemSum(this.form);">
											</td>
											<td><%=opname%>      </td>
												<td><%=opprice%></td>
										  </tbody>
...
<script language="javascript">
	...
	//		  if (document.getElementById("noArray").value=50000)	{
	//									document.getElementById("noArray").value = "yun1";
	//								} 
	//								else if (document.getElementById("noArray").value=110000) {
	//									document.getElementById("noArray").value = "yun2";
	//								} 
