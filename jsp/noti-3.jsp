...
<head>
  ...
  <link rel="stylesheet" href="css/noti-3.css" />
  <title>공지사항</title>
</head>
<%
    ...
    <section id="noti" class="content">
        <div class="inner">
            ...
            <div class="wrap">
                <div class="tit">
                    <h4>[공지]</h4>
                    <span>한국 울쎄라 골드스탠다드 프로토콜 개발 참여</span>
                    <p>2022.02.23</p>
                </div>
                <div class="txt">
                    <img src="img/noti-3.jpg" alt="">

                    <p>울쎄라 치료 만족도를 높이기 위해 한국인에게 맞는 새로운 부위별 가이드라인이 개발되었습니다.</p>
                </div>
                <div class="wow">
                    <div class="mok">
