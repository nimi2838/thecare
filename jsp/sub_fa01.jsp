...
<script language="javascript">
        ...
        if(value=="OPEN") {
			...
			$('#txt_getChkList').attr('style', "display:inline-block;width: 490px; height:150px; outline:none; border: 0; background: #fff; font-size: 20px; line-height:50px; padding:30px 30px ; text-rendering: none; appearance:none; resize: none; font-weight:bold; color: #555; font-family: 'ChosunSg'; overflow:hidden;");
    ...
    <div class="sub_con_box1">
        <div class="sub_con1">
            ...
            <p class="memo" style="line-height: 30px;">
               5주간의 프로그램은 레이저토닝 + 클라리티 + 진정(크라이오셀) + 화이트닝 + 비타민관리를 받을 수 있습니다.
            </p>
